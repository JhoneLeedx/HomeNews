...
public class NBAEndFragment extends Fragment implements NBAContract.View, NBAListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_nab_end, container, false);
    ...
    public void showUrl(String url) {
       ...
       // intent.putExtra("imgurl",((News)news).getThumbnail_pic_s());
        ...
        getActivity().overridePendingTransition(R.anim.anim_activity_right_in,R.anim.anim_activity_right_out);
    }
}
